...
$latam->CadastrarCategoria("ouro", "1000");
$latam->CadastrarCategoria("diamante", "2000");
$latam->CadastrarCategoria("platina", "3000");
$passageiro = $latam->PromoverVIP($passageiro);


 $datacliente = DateTime::createFromFormat("d/m/Y", "18/06/2023");

 $lista_viagens = $cliente->SolicitarViagem($afonso, $confins, $datacliente, 1);
...
$latam->CadastrarPiloto($piloto);
$latam->CadastrarPiloto($copiloto);
$latam->CadastrarComissario($comissario1);
$latam->CadastrarComissario($comissario2);

$viagem_escolhida[0]->setAeronave($aviao1);
...
//$latam->executaViagem($v[0]);
echo count($azul->getPLanejamentos());
